...
(
  ...
  from cv_grp
  where (inv1_type in ('Multi-lumen', 'Introducer','Trauma Line', 'TripleIntroducer'))
     OR (inv2_type in ('Multi-lumen', 'Introducer','Trauma Line', 'TripleIntroducer'))
     OR (inv3_type in ('Multi-lumen', 'Introducer','Trauma Line', 'TripleIntroducer'))
     OR (inv4_type in ('Multi-lumen', 'Introducer','Trauma Line', 'TripleIntroducer'))
     OR (inv5_type in ('Multi-lumen', 'Introducer','Trauma Line', 'TripleIntroducer'))
     OR (inv6_type in ('Multi-lumen', 'Introducer','Trauma Line', 'TripleIntroducer'))
     OR (inv7_type in ('Multi-lumen', 'Introducer','Trauma Line', 'TripleIntroducer'))
     OR (inv8_type in ('Multi-lumen', 'Introducer','Trauma Line', 'TripleIntroducer'))
)
